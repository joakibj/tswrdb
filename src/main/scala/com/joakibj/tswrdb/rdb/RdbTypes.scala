...
final class RdbTypes {
  final val data: List[RdbType] = List(
    ...
    RdbType(1000042, "", 12, FileType("dat")),
    ...
    RdbType(1000048, "", 0, FileType("dat")),
    RdbType(1000049, "Lighting", 0, FileType("dat")),
    RdbType(1000050, "XML - Territories", 12, FileType("xml")),
    RdbType(1000052, "", 0, FileType("dat")),
    RdbType(1000053, "XML - Bounded Area", 12, FileType("xml")),
    RdbType(1000054, "", 0, FileType("dat")),
    RdbType(1000055, "Bounded Area", 12, FileType("dat")),
    RdbType(1000057, "", 0, FileType("dat")),
    RdbType(1000058, "", 0, FileType("dat")),
    RdbType(1000059, "Environ Area", 0, FileType("dat")),
    RdbType(1000060, "", 0, FileType("dat")),
    RdbType(1000061, "", 0, FileType("dat")),
    RdbType(1000069, "", 0, FileType("dat")),
    RdbType(1000070, "XML - Climb", 12, FileType("xml")),
    RdbType(1000071, "", 0, FileType("dat")),
    RdbType(1000075, "XML - Rivers", 12, FileType("xml")),
    RdbType(1000076, "", 0, FileType("dat")),
    RdbType(1000080, "", 0, FileType("dat")),
    RdbType(1000081, "", 0, FileType("dat")),
    ...
    RdbType(1000094, "", 0, FileType("dat")),
    ...
    RdbType(1000102, "", 0, FileType("dat")),
    RdbType(1000103, "XML - Static AI Points", 0, FileType("xml")),
    RdbType(1000104, "", 0, FileType("dat")),
    ...
    RdbType(1000507, "", 0, FileType("dat")),
    RdbType(1000508, "Monsters", 0, FileType("dat")),
    RdbType(1000509, "", 0, FileType("dat")),
    RdbType(1000510, "", 0, FileType("dat")),
    RdbType(1000511, "", 0, FileType("dat")),
    RdbType(1000512, "", 0, FileType("dat")),
    RdbType(1000513, "", 0, FileType("dat")),
    RdbType(1000514, "", 0, FileType("dat")),
    RdbType(1000515, "", 0, FileType("dat")),
    RdbType(1000516, "", 0, FileType("dat")),
    ...
    RdbType(1010034, "", 0, FileType("dat")),
    ...
    RdbType(1040007, "", 12, FileType("dat")),
    RdbType(1040008, "", 12, FileType("dat")),
    RdbType(1040009, "", 12, FileType("dat")),
    ...
    RdbType(1065102, "", 0, FileType("dat")),
